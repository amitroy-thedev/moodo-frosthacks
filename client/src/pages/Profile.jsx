      ...
      <div className="space-y-6">
        ...
        <div className="bg-foreground rounded-3xl p-8 text-background relative overflow-hidden">
          <div className="relative z-10 space-y-4">
            <h4 className="text-xl font-bold font-display">Privacy Guarantee</h4>
            ...
            <div className="flex items-center gap-4 pt-2">
              <div className="flex items-center gap-2 text-xs font-bold text-background/60 uppercase tracking-widest">
                <Shield className="w-4 h-4" />
                GDPR Compliant
              </div>
              <div className="flex items-center gap-2 text-xs font-bold text-background/60 uppercase tracking-widest">
